...
public class MainActivity extends AppCompatActivity
{
   ...
   private FirebaseAuth mAuth;//to check user authentication loggedin or not
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        navProfileImage = nav_view.findViewById(R.id.post_profile_image);
        navUsername = nav_view.findViewById(R.id.post_profile_image);
...
//                Toast.makeText(this, "Home icon Action", Toast.LENGTH_SHORT).show();
    ...
    public void goToPosts(){
        Intent goToLoginActivity = new Intent(getApplicationContext(),Posts_commentActivity.class);
        goToLoginActivity.addFlags(Intent.FLAG_ACTIVITY_NEW_TASK | Intent.FLAG_ACTIVITY_CLEAR_TASK);
        startActivity(goToLoginActivity);
        finish();
    }
    public void goToPosts2(){
        Intent goToLoginActivity = new Intent(getApplicationContext(),PostActivity.class);
        goToLoginActivity.addFlags(Intent.FLAG_ACTIVITY_NEW_TASK | Intent.FLAG_ACTIVITY_CLEAR_TASK);
        startActivity(goToLoginActivity);
        finish();
    }
